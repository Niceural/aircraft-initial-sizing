class KnownWeight:
    def __init__(self, config):
        ...
        self.payload = PayloadWeight(payload["unfactored weight"], payload["safety factor"])
...
class PayloadWeight:
    ...
    def get_weight(self):
        return self.unfactored_weight * (1. + self.safety_factor)
...
class PassengerWeight:
    ...
    def get_weight(self):
        return self.number_of_passengers * (self.passenger_weight + self.baggage_weight) * (1. + self.safety_factor)
...
class CrewWeight:
    ...
    def get_weight(self):
        return self.number_of_crew * self.crew_weight * (1. + self.safety_factor)